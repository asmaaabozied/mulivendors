									...
									<div class="row">
										<div class="col-lg-4">
											<div class="left-area">
												...
												<p class="sub-heading"><a href="http://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank">{{ __('How to get purchase code?') }}</a></p>
											</div>
										</div>
										<div class="col-lg-7">
