...
class PaytmController extends Controller
{
    ...
    $user = Auth::user();
     ...
     $item_amount = $subs->price;
	    ...
	    $paytm_txn_url = 'http://securegw-stage.paytm.in/theia/processTransaction';
    ...
    if ($gs->paytm_mode == 'sandbox') {
      ...
      define('PAYTM_ENVIRONMENT', 'PROD'); // PROD
		...
		$PAYTM_STATUS_QUERY_NEW_URL='http://securegw-stage.paytm.in/merchant-status/getTxnStatus';
		$PAYTM_TXN_URL='http://securegw-stage.paytm.in/theia/processTransaction';
		if (PAYTM_ENVIRONMENT == 'PROD') {
			$PAYTM_STATUS_QUERY_NEW_URL='http://securegw.paytm.in/merchant-status/getTxnStatus';
			$PAYTM_TXN_URL='http://securegw.paytm.in/theia/processTransaction';
		}
