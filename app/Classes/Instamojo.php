...
class Instamojo {
    ...
    protected $curl;
    protected $endpoint = 'http://www.instamojo.com/api/1.1/';
    ...
    */
    ...
    public function getCurlValue($file_path, $file_name, $content_type='')
    {
        ...
        // See: http://wiki.php.net/rfc/curl-file-upload
    ...
    * docs: http://www.instamojo.com/developers/request-a-payment-api/#toc-filtering-payment-requests
    */
